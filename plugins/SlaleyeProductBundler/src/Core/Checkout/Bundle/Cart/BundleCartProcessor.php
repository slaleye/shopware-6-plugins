...
namespace Slaleye\ProductBundler\Core\Checkout\Bundle\Cart;
...
use Slaleye\ProductBundler\Core\Content\Bundle\BundleCollection;
...
{
    public const TYPE = 'slaleyeproductbundlerbundle';
    public const DISCOUNT_TYPE = 'slaleyeproductbundlerbundle-discount';
    public const DATA_KEY = 'slaleye_product_bundler-';
